...
function guitar_chord_writer() {
	this.notes =     ["C",  "C#", "Db", "D",  "D#", "Eb", "E",  "F",  "F#", "Gb", "G",  "G#", "Ab", "A",  "A#", "Bb", "B",  "C", "C#"];
	this.upnotes =   ["C#", "D",  "D",  "D#", "E",  "E",  "F",  "F#", "G",  "G",  "G#", "A",  "A",  "A#", "B",  "B",  "C",  "C#",  "D"];
	this.downnotes = ["B",  "C",  "C",  "Db", "D",  "D",  "Eb", "E",  "F",  "F",  "Gb", "G",  "G",  "Ab", "A",  "A",  "Bb", "B",  "B"];
	...
	this.init = function(transposition_text, up, key, down) {
		...
		//$("<span class='chord-inline'> " + key + " </span>").appendTo($(song_selector + " div"));
